...
plugins=(mark gitfast git-extras tmux dirhistory rbenv thefuck brew docker gem z zsh-syntax-highlighting kubectl ansible zsh-autosuggestions web-search)
